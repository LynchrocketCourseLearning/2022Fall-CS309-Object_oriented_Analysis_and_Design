...
public class MainFrame extends JFrame {
    ...
    public MainFrame() {
        ...
        WhiteRandomBall whiteRandomBall = new WhiteRandomBall(Color.WHITE, (int) (Math.random() * 3) + 4, (int) (Math.random() * 3) + 4, 300);
        mainPanel.setWhiteBallRandom(whiteRandomBall);
